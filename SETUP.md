...
Starting Appium v.1.20, no further installations are needed! (before v.1.20, a separate program AppiumForMac was required) However, one additional configuration is still required:
